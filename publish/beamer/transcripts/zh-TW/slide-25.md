...
**MEDIUM 列 — 流程與底層。**
4.6 工作流編譯：ADG（智慧體相依圖——智慧體程式的靜態 IR）檢查、freeze、放置——到 Horizon B 的 T10 路徑。FlowCompile 與 AgentFlow *編譯或分析*圖；**DeepSeek Harness** *跑*一棵活的外掛樹加 session log——T10 著色，不是已編譯 IR。已編譯智慧體圖上的失敗即關 CI 仍缺。4.8 人工審查流程：CODEOWNERS、簽署 admit、HITL（人在迴圈內）容量——智慧體產出草稿的速度比審查擴得快。4.9 安全：沙箱、溯源、供應鏈——TCB 裡的智慧體核心要跟手寫程式碼同一標準。
