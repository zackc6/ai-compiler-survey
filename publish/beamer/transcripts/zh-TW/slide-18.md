...
**C9 — 覆蓋 vs 峰值（鋼）。**
*今日：*核心智慧體追熱算子峰值；使能 SKU 挨餓。*Flip：* TritorX → **KernelEvolve** 梯子成為*出貨*第二供應商矽的**公開劇本**。**Zomboss** 是學術類比。**MaxKernel**（Google，Pallas/TPU）與 **Hyperloom**（AMD Instinct 端到端）是 2026 年 9 月在成熟編譯器上的*峰值*智慧體——也**不是**那次結算。*後果：*產品 **SKU** 先賣**覆蓋 SLA**（服務水準協議——算子面正確性），再賣**效能 SLA**。
