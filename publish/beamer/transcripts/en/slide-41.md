...
30 GPU kernels & inference · 15 agentic & RL · 14 source control & review · 12 classic DL compilers · 10 company infra · 10 forums & workshops · 8 surveys & vision · 12 foundation LLMs · 6 MLGO & RL gyms · 6 HW codesign & bring-up · 6 commercial products · 6 control-plane substrate · 1 correctness lineage. Total **136** digests — tiered, not flat. This wave: vendor L4 kernel IRs missed by the LLM+IR title search — TileLang, Gluon, TLX, FlyDSL, CuTe DSL, Event Tensor, ThunderKittens 2.0. Previous: **TIRx**, then LLM-oriented IR (LLM4IR ★, IntOpt, IRIS-14B, ComPile, IRCoder). Event Tensor is L6 megakernel IR, not an L-llm. **TLX ≠ TIRx ≠ TritorX**.
