...
**36** GPU kernels & inference · 15 agentic & RL · 14 source control & review · **13** classic DL compilers · 10 company infra · 10 forums & workshops · 8 surveys & vision · 12 foundation LLMs · 6 MLGO & RL gyms · 6 HW codesign & bring-up · **7** commercial products · 12 control-plane substrate · 1 correctness lineage. Total **150** digests. This wave: MaxKernel, JAXBench, Pallas, AMDKernelVault, KernelGenBench, Hyperloom, AsmEvo, ForgeMegakernel. Hybrid holds; C9 does not settle. **Pallas ≠ PLENA**. **ForgeMegakernel ≠ KernelForge ≠ Kernel Forge**. **TLX ≠ TIRx ≠ TritorX**.
