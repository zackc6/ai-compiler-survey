...
*Today:* kernel agents chase peak on hot ops; bring-up SKUs starve. *Flip:* TritorX → **KernelEvolve** ladder becomes a **public playbook** for *shipping* second-vendor silicon. **Zomboss** is an academic analog. **MaxKernel** (Google, Pallas/TPU) and **Hyperloom** (AMD Instinct e2e) are September 2026 *peak* agents on mature compilers — also **not** that settlement. *Consequence:* product **SKU** sells **coverage SLA** (Service Level Agreement — op surface correctness) **first**, **performance SLA** second.
