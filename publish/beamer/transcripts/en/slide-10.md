...
- **L4 Kernel DSL** — Triton, Helion, **TileLang**, CuTe, **TIRx** (TVM Tensor IR next); tile-level programmability. Helion raises Triton; **Gluon** / **TLX** lower or extend it. TIRx’s own search rungs L1–L4 are *agent-search* levels, **not** these data-plane bands. **TLX ≠ TIRx ≠ TritorX**.
