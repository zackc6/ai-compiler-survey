...
2. **Answer four research questions**
   ...
   - **Q4 Gaps** — What is missing for production, correctness, benchmarks, and interoperability?
...
docs/
  SURVEY.md               # Expanded survey narrative (Q1–Q4)
