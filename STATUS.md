...
| Architecture | Application optimization, controller improvement, and compiler evolution are distinct evaluation targets; component boundaries remain choices to evaluate. An end-to-end blueprint figure (`docs/blueprint.svg`) illustrates one arrangement. |
...
| Publication | Blueprint batch: direct publication to main authorized by the maintainer. |
