...
META: dict[str, tuple[str, str]] = {
    ...
    "tilelang.md": ("Peking University · Microsoft Research · Imperial College London", "arXiv"),
    ...
    "compile.md": ("UC Davis · TUM · LLNL · UIUC · ANL · Google et al.", "arXiv · Hugging Face"),
    "ircoder.md": ("TU Darmstadt · University of Würzburg", "ACL 2024 · arXiv"),
    "llm4ir.md": ("Kent State University · HUST · PNNL · Chongqing University", "ICML 2025 · PMLR · arXiv"),
    "iris-14b.md": ("Barcelona Supercomputing Center · Universitat Politècnica de Catalunya", "arXiv"),
    "intopt.md": ("SKLP, ICT, CAS · UCAS · Jiangnan University · The Chinese University of Hong Kong", "arXiv"),
    ...
    "triton-gluon.md": ("Triton project (OpenAI / community)", "Triton docs"),
    "tlx.md": ("UC San Diego · Meta", "arXiv"),
    "flydsl.md": ("AMD", "AMD ROCm blog"),
    "cute-dsl.md": ("NVIDIA", "NVIDIA Developer blog"),
    "event-tensor.md": ("Carnegie Mellon University · NVIDIA et al.", "MLSys 2026 · arXiv"),
    "thunderkittens.md": ("Stanford Hazy Research", "Hazy Research blog"),
