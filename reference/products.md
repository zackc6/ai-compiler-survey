...
| [GEPA](publications/gepa.md) | Evolved instructions for fixed-model agents, with preliminary kernel experiments. | Research evidence for a restricted controller change; no production self-evolving compiler claim. |
| [Meta-Harness](publications/meta-harness.md) and [Hyperagents](publications/hyperagents.md) | Automated harness design and editable improvement procedures. | General-agent research prototypes; compiler transfer remains an experiment. |
